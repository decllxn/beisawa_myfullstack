    ...
    <div className={styles.contactInfo}>
      ...
      <div className={styles.info}>
        <div className={styles.information}>
          <div className={styles.icon}><i className="ri-map-pin-2-line"></i></div>
          <p>Meru, Kenya</p>
        </div>
        <div className={styles.information}>
          <div className={styles.icon}><i className="ri-mail-line"></i></div>
          <p>beisawa@gmail.com</p>
        </div>
        <div className={styles.information}>
          <div className={styles.icon}><i className="ri-phone-line"></i></div>
          <p>0712345678</p>
        </div>
      </div>
    </div>
